 ...
 * 2023-08-05T17:33:21.914+02:00
 * Generated source version: 4.0.0
 *
 */
@WebServiceClient(name = "CustomerWS",
                  wsdlLocation = "file:/E:/Work/WorkSpace-back/apis-rest-graphql-soap-grpc/customer-service-account/src/main/resources/CustomerService.wsdl",
                  targetNamespace = "http://web.customerdataservice.api.net/")
public class CustomerWS extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://web.customerdataservice.api.net/", "CustomerWS");
    public final static QName CustomerSoapServicePort = new QName("http://web.customerdataservice.api.net/", "CustomerSoapServicePort");
    static {
        URL url = null;
        try {
            url = new URL("file:/E:/Work/WorkSpace-back/apis-rest-graphql-soap-grpc/customer-service-account/src/main/resources/CustomerService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CustomerWS.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/E:/Work/WorkSpace-back/apis-rest-graphql-soap-grpc/customer-service-account/src/main/resources/CustomerService.wsdl");
        }
        WSDL_LOCATION = url;
    }
