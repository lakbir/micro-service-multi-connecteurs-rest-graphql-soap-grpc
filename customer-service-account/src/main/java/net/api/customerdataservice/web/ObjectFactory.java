 ...
 * generated in the net.api.customerdataservice.web package. 
...
public class ObjectFactory {
    ...
    private final static QName _CustomerById_QNAME = new QName("http://web.customerdataservice.api.net/", "customerById");
    private final static QName _CustomerByIdResponse_QNAME = new QName("http://web.customerdataservice.api.net/", "customerByIdResponse");
    private final static QName _CustomerList_QNAME = new QName("http://web.customerdataservice.api.net/", "customerList");
    private final static QName _CustomerListResponse_QNAME = new QName("http://web.customerdataservice.api.net/", "customerListResponse");
    private final static QName _SaveCustomer_QNAME = new QName("http://web.customerdataservice.api.net/", "saveCustomer");
    private final static QName _SaveCustomerResponse_QNAME = new QName("http://web.customerdataservice.api.net/", "saveCustomerResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: net.api.customerdataservice.web
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://web.customerdataservice.api.net/", name = "customerById")
     ...
     */
    @XmlElementDecl(namespace = "http://web.customerdataservice.api.net/", name = "customerByIdResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://web.customerdataservice.api.net/", name = "customerList")
     ...
     */
    @XmlElementDecl(namespace = "http://web.customerdataservice.api.net/", name = "customerListResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://web.customerdataservice.api.net/", name = "saveCustomer")
     ...
     */
    @XmlElementDecl(namespace = "http://web.customerdataservice.api.net/", name = "saveCustomerResponse")
